...
const TodoList = () => {
    ...
    return (
        <div className="overflow-x-auto w-full mt-10">
            <table className="table w-5/6 xl:w-3/6 mx-auto bg-base-100 shadow-xl border">
                {/* head */}
                <thead>
                <tr className='text-l'>
                    <th>Item</th>
                ...
                data.map((item:any) => {
                    ...
                    <tr>
                        ...
                        <td className='w-1/3'>{ status === true ? (
                        ...
                        <th className='justify-center space-y-2 w-1/4 flex flex-col md:flex-row md:space-y-0 md:space-x-5 md:mx-auto'>
                        <button className="btn bg-sky-500 btn-xs mx-auto">
                        ...
                        })} className="btn bg-green-500 btn-xs mx-auto">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
                        ...
                        <button onClick={() => handledelete(item.id)} className="btn bg-red-500 btn-xs mx-auto">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
